...
def add_menu_item():
    ...
    if request.method == 'POST':
        ...
        # Convert from DKK to øre (multiply by 100)
...
# Run on port 5002 to avoid conflict with Sanjaya's Sales system on port 5000
