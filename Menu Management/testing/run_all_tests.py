...
if "redirect" in r.text or r.status_code == 302 or "/admin/menu" in r.text or r.url.endswith("/admin/menu"):
    print("✅ PASS: Login successful")
else:
    print("❌ FAIL: Could not login")

# Test 4: Access Menu List (after login)
...
# Test 5: Add new menu item (unique name)
